...
exports.deleteSingleBookFromDB = exports.updateSingleBookToDB = exports.getSingleBookFromDB = exports.getAllBookByCategoryFromDB = exports.getAllBookFromDB = exports.createBookToDB = void 0;
const http_status_1 = __importDefault(require("http-status"));
const ApiError_1 = __importDefault(require("../../../errors/ApiError"));
const paginationHelper_1 = require("../../../helpers/paginationHelper");
const prisma_1 = require("../../../shared/prisma");
const book_constant_1 = require("./book.constant");
const createBookToDB = (bookData) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllBookByCategoryFromDB = (filters, paginationOptions, id) => __awaiter(void 0, void 0, void 0, function* () {
    const { page, size, skip, sortBy, sortOrder } = (0, paginationHelper_1.calculatePagination)(paginationOptions);
    const { searchTerm } = filters, filtersData = __rest(filters, ["searchTerm"]);
    const andCondition = [];
    if (searchTerm) {
...
const getSingleBookFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "There is no book with the id/Failed to fetched book");
    }
});
exports.getSingleBookFromDB = getSingleBookFromDB;
const updateSingleBookToDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "There is no book with the id/Failed to update book");
    }
});
...
const deleteSingleBookFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "There is no book with the id/Failed to delete book");
    }
});
