...
exports.deleteSingleCategoryFromDB = exports.updateSingleCategoryToDB = exports.getSingleCategoryFromDB = exports.getAllCategoryFromDB = exports.createCategoryToDB = void 0;
const http_status_1 = __importDefault(require("http-status"));
const ApiError_1 = __importDefault(require("../../../errors/ApiError"));
const paginationHelper_1 = require("../../../helpers/paginationHelper");
const prisma_1 = require("../../../shared/prisma");
const category_constant_1 = require("./category.constant");
const createCategoryToDB = (categoryData) => __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleCategoryFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "There is no category with the id/Failed to fetched category");
    }
});
exports.getSingleCategoryFromDB = getSingleCategoryFromDB;
const updateSingleCategoryToDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "There is no category with the id/Failed to update category");
    }
});
exports.updateSingleCategoryToDB = updateSingleCategoryToDB;
const deleteSingleCategoryFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "There is no category with the id/Failed to delete category");
    }
});
