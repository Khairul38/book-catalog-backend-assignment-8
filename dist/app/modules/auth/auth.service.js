...
exports.refreshTokenUserFromDB =
  exports.loginUserFromDB =
  exports.createUserToDB =
    void 0;
...
const loginUserFromDB = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      ...
      !(yield (0, passwordMatchHelper_1.isPasswordMatched)(
        password,
        isUserExist.password
      ))
    ) {
...
const refreshTokenUserFromDB = token =>
  __awaiter(void 0, void 0, void 0, function* () {
    //verify token
    // invalid token - synchronous
    let verifiedToken = null;
    try {
      verifiedToken = (0, jwtHelpers_1.verifyToken)(
        token,
        config_1.default.jwt.refresh_secret
      );
    } catch (err) {
